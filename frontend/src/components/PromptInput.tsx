  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        ...
        disabled={disabled}
        title={disabled ? "Cannot enter prompt while a command is running" : undefined}
      ...
      <button
        ...
        title={disabled ? "A command is currently running" : !value.trim() ? "Enter a prompt first" : "Run prompt"}
